...
const ExpenseTable = forwardRef(
  ({ expenses, setExpenses, setExpense, setEditingRowId }, ref) => {
    ...
    // Expose setMenuPosition to the parent
    ...
    // Filter expenses based on the query
    // useEffect(() => {
    ...
    //     record.category.toLowerCase().includes(query.toLocaleLowerCase())
    //   );
    // }, [query, expenses]);
